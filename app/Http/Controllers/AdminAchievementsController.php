<?php namespace App\Http\Controllers;
	...
	class AdminAchievementsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->add_btn_name = 'Add Achievement';
			...
			$this->form[] = ['label'=>'By','name'=>'by','type'=>'text','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"By","name"=>"by","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
	    ...
	    */
	    ...
	    public function getSetStatus($status,$id) {
		   DB::table('achievements')->where('id',$id)->update(['status'=>$status]);
